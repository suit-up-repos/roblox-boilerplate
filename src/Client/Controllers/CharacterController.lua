...
function CharacterController:KnitStart()
	LocalPlayer.CharacterAdded:Connect(function(character)
		...
		WaitFor.Child(humanoid, "Animator")
			:andThen(function(animator) -- // Animator being available typically means character is loaded
				-- // do things after finding the Animator object like loading animations
			end)
			:finally(function() -- // use Promises to ensure that this eventually happens
